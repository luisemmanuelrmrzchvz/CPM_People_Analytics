    ...
    > 
      ...
      > 
        ...
        > 
          ...
          > tryCatch(
            ...
            +   error = function(e) {
              ...
              +   }
            + )
        Error al insertar los datos:  Columns `Col1`, `Col2`, `Col3`, `Col4`, `Col5`, `Col7`, `Col8`, `Col9`, `Col10`, `Col11`, `Col12`, `Col13`, `Col14`, `Col15`, `Col16` not found 
        ...
        stop("Columns ", paste0("`", setdiff(names(value), col_names),
                                "`", collapse = ", "), " not found", call. = FALSE)
        8.
        match_col(value, col_names)
        7.
        .local(conn, name, value, ...)
        6.
        dbWriteTable(con, tabla_sqlite, datos_filtrados, append = TRUE,
                     row.names = FALSE)
        5.
        dbWriteTable(con, tabla_sqlite, datos_filtrados, append = TRUE,
                     row.names = FALSE)
