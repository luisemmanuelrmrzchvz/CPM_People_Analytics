...
ruta_archivo <- "C:/Users/racl26345/Documents/Reportes Automatizados/Inputs/CPM_09_Interacciones.xlsx"

# Leer el archivo de Excel, omitiendo las primeras 9 filas (la fila 10 contiene los títulos)
datos <- read_excel(ruta_archivo, range = cell_rows(10:100000), col_names = FALSE)
